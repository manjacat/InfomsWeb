...
namespace InfomsWeb.Models
{
    ...
    public class ModuleRPSTable
    {
        ...
        public static IEnumerable<ModuleRPSTable> GetListFromDataTable()
        {
            List<ModuleRPSTable> tempList = new List<ModuleRPSTable>();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    ModuleRPSTable m = new ModuleRPSTable
                    {
